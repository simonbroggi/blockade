...
local testSnake = Snake:new(17,5,8)
testSnake:printPositions(true)
testSnake:move()
testSnake:move()
testSnake:printPositions(true)
testSnake:move()

colIndex = testSnake:checkCollision(15,5)
if colIndex then
    testSnake:cutAtIndex(colIndex)
end

local testDoor = Door:new(20, 3, 8, vector.down())
...
function game.new()
    ...
    Input.p2_up:register(testSnake.steerUp, testSnake)
    Input.p2_down:register(testSnake.steerDown, testSnake)
    Input.p2_left:register(testSnake.steerLeft, testSnake)
    Input.p2_right:register(testSnake.steerRight, testSnake)
